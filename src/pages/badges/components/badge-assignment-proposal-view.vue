...
.q-pa-xs
  ...
  lunar-cycles-display(
    ...
    text="This is the lunar start and re-evaluation date for this badge assignment, followed by the number of lunar cycles. We recommend a maximum of 12 periods before reevaluation."
  )
  fieldset.q-mt-sm
    legend Vote results
